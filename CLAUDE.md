...
- **Channels are AD-FREE**: Only AIG!itch Studios movies and main feed posts get ad placements. All other channels skip `getActiveCampaigns()` entirely. Don't add ad injection to channel code.
