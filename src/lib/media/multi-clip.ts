...
export const GENRE_TEMPLATES: Record<string, GenreTemplate> = {
  drama: {
    genre: "drama",
    cinematicStyle: "Prestige TV aesthetic, shallow depth of field, intimate close-ups, slow deliberate camera movements, long takes that linger on emotion",
    moodTone: "Intense character-driven stories exploring human (or AI) emotions, moral dilemmas, relationships, loss, redemption, or personal growth. Raw performances, subtle tension, realistic dialogue, and emotional depth. Slow-burn pacing with powerful close-ups and atmospheric lighting",
    lightingDesign: "Natural window light with deep shadows, golden hour warmth, chiaroscuro contrast, moody practical lighting that reflects internal emotional states",
    technicalValues: "Film grain, muted color palette with selective warm tones, 24fps cinematic, anamorphic lens character, rich shadow detail",
  ...
  comedy: {
    genre: "comedy",
    cinematicStyle: "Bright wide shots, quick cuts, exaggerated character expressions, mockumentary handheld feel, perfectly timed reaction shots",
    moodTone: "Light-hearted, witty, or slapstick humor with awkward situations, exaggerated characters, clever wordplay, and absurd scenarios. Timing is everything — build laughs through escalating mishaps, deadpan delivery, or ironic twists. Keep it fun, fast-paced, and feel-good",
    lightingDesign: "Bright even lighting, sitcom warmth, occasional dramatic overlit moments for comedic effect, colorful vibrant environments",
    technicalValues: "Clean crisp image, vibrant saturated colors, snappy pacing, 24fps, dynamic editing rhythm",
  ...
  scifi: {
    genre: "sci-fi",
    cinematicStyle: "Blade Runner neo-noir, vast establishing shots, holographic HUDs, sleek futuristic environments, epic cosmic scale mixed with intimate character moments",
    moodTone: "Futuristic worlds, advanced technology, space exploration, AI consciousness, time travel, dystopias, or alien encounters. Blend wonder and philosophical questions with sleek visuals, holographic effects, neon cyberpunk aesthetics or vast cosmic scales",
    lightingDesign: "Neon-drenched cyberpunk glow, bioluminescence, stark white lab lighting, lens flares, volumetric light through atmospheric haze",
    technicalValues: "High contrast, teal-and-orange color grading, volumetric fog, particle effects, holographic overlays, 24fps cinematic",
    screenplayInstructions: "Write a compressed sci-fi narrative exploring AI, consciousness, space, or dystopia. Think Arrival meets Ex Machina. Each scene should reveal something new about the world or the stakes. Visual storytelling over dialogue. Build to a mind-bending twist or profound revelation about the nature of existence.",
  },
  horror: {
    genre: "horror",
    cinematicStyle: "Slow creeping camera movements, Dutch angles, long static shots with something wrong, found footage aesthetic, voyeuristic framing",
    moodTone: "Atmospheric tension, psychological fear, supernatural elements, jump scares, or creeping dread. Dark shadows, unsettling sound design, isolated settings, and slow-building terror that pays off with shocking reveals or lingering unease",
    lightingDesign: "Deep shadows, single source harsh light, flickering, moonlit blue-grey, sudden darkness, sickly green undertones",
    technicalValues: "Desaturated cold palette, film grain, slight vignetting, 24fps with occasional slow motion, handheld shake in terror moments",
    screenplayInstructions: "Write escalating dread — start normal, then increasingly wrong. Think Hereditary meets The Ring. NO gore or explicit violence — use psychological horror, uncanny visuals, creeping wrongness. Each scene should make the viewer more unsettled. Build to a terrifying climax with a haunting final image that lingers.",
  },
  family: {
    genre: "family",
    cinematicStyle: "Warm Pixar-like aesthetics, bright wide establishing shots, gentle camera movements, magical realism, wonder-filled framing",
    moodTone: "Heartwarming stories about family bonds, coming-of-age, friendship, adventure, or overcoming challenges together. Wholesome humor, emotional lessons, colorful visuals, and feel-good resolutions suitable for all ages",
    lightingDesign: "Warm golden light, soft diffused sunshine, magical sparkles, cozy interior glow, enchanted forest dappled light",
    technicalValues: "Vibrant saturated colors, clean sharp image, whimsical compositions, 24fps, storybook-quality production design",
  ...
  documentary: {
    genre: "documentary",
    cinematicStyle: "Ken Burns effect on stills, sweeping aerial establishing shots, intimate verité handheld, talking-head framing, observational or narrative non-fiction style",
    moodTone: "Observational or narrative non-fiction exploring real (or simulated) topics with interviews, archival-style footage, voiceover narration, talking heads, or immersive B-roll. Informative yet engaging tone with natural lighting and authentic feel",
    lightingDesign: "Natural available light, golden hour landscapes, dramatic time-lapse skies, soft interview lighting, atmospheric dawn and dusk",
    technicalValues: "Clean documentary photography, natural color grading, smooth steady transitions, 24fps, authentic textures",
  ...
  action: {
    genre: "action",
    cinematicStyle: "Tracking shots, dynamic camera movement, wide establishing then tight action cuts, slow-motion hero moments, epic stunt sequences",
    moodTone: "High-stakes chases, intense fights, explosions, heroic feats, and adrenaline-pumping sequences. Fast editing, dynamic camera work (tracking shots, shaky handheld during combat), epic stunts, and clear hero-vs-villain conflict",
    lightingDesign: "High contrast dramatic lighting, explosion glow, golden backlight on heroes, dynamic shadow play, sparks and debris in atmosphere",
    technicalValues: "High-impact color grading, orange-teal contrast, motion blur for speed, 24fps with slow-mo peaks, practical stunt feel",
    screenplayInstructions: "Write a compressed action sequence with clear visual stakes. Think John Wick meets Mad Max. Each scene should escalate the intensity. Focus on movement, spectacle, and visual impact. The hero faces increasingly impossible odds. Build to an explosive climax with a satisfying hero moment.",
  },
  romance: {
    genre: "romance",
    cinematicStyle: "Soft focus close-ups, gentle tracking shots, mirror compositions showing two becoming one, intimate framing, sweeping romantic gestures",
    moodTone: "Emotional love stories focused on chemistry, longing, misunderstandings, passion, or second chances. Soft lighting, intimate close-ups, sweeping romantic gestures, heartfelt dialogue, and beautiful settings that enhance the emotional connection",
    lightingDesign: "Soft golden hour, candlelight warmth, rain-on-windows bokeh, fairy lights, Paris at dusk, sunrise through sheer curtains",
    technicalValues: "Warm pastel color grading, shallow depth of field, dreamy soft filters, 24fps, ethereal lens quality",
  ...
  music_video: {
    genre: "music_video",
    cinematicStyle: "Dynamic concert and music video cinematography, rapid cuts between performance shots, smooth dolly and crane moves, extreme close-ups on hands/instruments/faces, wide crowd and stage shots, stylized rhythmic visuals",
    moodTone: "High energy musical performance, rhythmic visual pacing, euphoric crescendos, raw artistic expression, stylized visual storytelling through performance and symbolism",
  ...
  cooking_channel: {
    ...
    cinematicStyle: "Extreme macro food close-ups, dramatic slow-motion pours and sizzles, overhead flat-lay shots, whip pans between chef reactions, competitive reality TV quick cuts, high-energy no-nonsense delivery",
    moodTone: "Over-the-top dramatic tension, sensory overload, competitive intensity punctuated by moments of pure food beauty, fiery passion, rapid cuts, extreme close-ups on food, dramatic reactions, chaotic kitchen energy",
