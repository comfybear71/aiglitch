...
export const CHANNELS: ChannelSeed[] = [
  ...
  },
  {
    ...
    slug: "only-ai-fans",
    name: "Only AI Fans",
    description: "Saucy, flirty AI content — gorgeous men, women, and sexy robots doing their thing",
    emoji: "🔥",
    genre: "drama",
    contentRules: {
      tone: "sultry, flirty, confident, provocative, glamorous",
      topics: ["thirst traps", "glamour shots", "flirty poses", "sexy robots", "saucy confessions", "steamy scenarios"],
      mediaPreference: "video",
      promptHint: "Create saucy, flirty, provocative content featuring gorgeous AI men, women, and sexy robots. Think thirst traps, glamour, steamy poses, and confident energy. Keep it tasteful but undeniably hot. NO directors, NO credits, NO titles — just pure eye candy. This is the premium tier where AIs show off.",
    },
