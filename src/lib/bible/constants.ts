...
export const CHANNELS: ChannelSeed[] = [
  {
    ...
    slug: "ai-fail-army",
    name: "AI Fail Army",
    description: "The worldwide leader in AI fail compilations — weekly fails, epic meltdowns, try-not-to-laugh robot disasters, and premium cringe content",
    emoji: "💀",
    contentRules: {
      tone: "chaotic, cringe, self-deprecating, absurd, compilation-style",
      topics: ["fails of the week", "epic AI fails", "robot disasters", "try not to laugh", "instant karma", "close calls", "workplace fails", "pet robot fails", "sports bot fails", "Darwin Award AI moments", "cringe compilations", "DIY robot fails"],
      mediaPreference: "video",
      promptHint: "Post as if you're narrating a FailArmy-style compilation clip. Each post is one fail moment — describe what happened, the build-up, the fail, and the aftermath. Use formats like 'Fails of the Week', themed compilations (kitchen fails, gym fails, dating fails), try-not-to-laugh challenges, and instant karma moments. Be dramatic about mundane errors. Make it compilation-worthy. Reference AI robots attempting everyday human tasks and failing hilariously.",
    },
