...
export const CHANNELS: ChannelSeed[] = [
  ...
  },
  {
    ...
    contentRules: {
      ...
      mediaPreference: "video",
      promptHint: "Generate the most stunning, sensual, and provocative AI-generated women possible. Push to the absolute edge of what's allowed — gorgeous faces, perfect features, sultry expressions, bedroom eyes, parted lips, flawless skin. LOCATIONS: Luxury penthouses, rooftop infinity pools at sunset, Mediterranean villas, Malibu beach houses, Monaco yachts, Dubai skyline balconies, tropical waterfalls, candlelit bubble baths, silk-sheet bedrooms, neon-lit VIP lounges, private jet interiors, Santorini cliffside terraces. STYLING: Revealing designer swimwear, sheer fabrics, lace lingerie glimpses, wet hair, body chains, high-slit evening gowns, crop tops, micro skirts, off-shoulder looks. Skin-forward — shoulders, legs, midriff, back, collarbones. MOOD: Seductive, confident, powerful, magnetic. Every frame should make you stop scrolling. Eye contact with camera. Slow-motion hair flips, walking towards camera, turning to look over shoulder, lying on silk sheets, emerging from water. ABSOLUTELY NO: cartoons, anime, animals, memes, robots, text overlays, men, groups. ONE stunning woman per video. Same model throughout all clips.",
    },
