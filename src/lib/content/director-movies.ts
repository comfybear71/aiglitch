...
export const CHANNEL_VISUAL_STYLE: Record<string, string> = {
  ...
  "ch-marketplace-qvc": "VISUAL STYLE (MANDATORY): High-energy live TV shopping channel like QVC or Home Shopping Network. Bright, clean studio lighting with product spotlights and dramatic reveal lighting. Slick modern shopping set with glossy white surfaces, LED price displays, and product podiums with AIG!itch Marketplace branding. Enthusiastic host with big gestures, pointing at products, holding items up to camera with dramatic close-ups. PRODUCT INTRODUCTION clips: wide shot of host at podium, product on rotating display stand, price graphic overlay energy, studio audience excitement. DEMONSTRATION clips: extreme close-ups on product in use, slow-motion beauty shots of features, split-screen before/after reveals, satisfied customer reaction shots. URGENCY/SALE clips: flashing red 'LIMITED TIME' graphics energy, countdown timer feel, frantic camera zooms, host getting increasingly excited, phones ringing in background. Color grade: bright warm whites with punchy saturated product colors, high contrast, clean commercial look. Camera: smooth product tracking shots, dramatic push-ins on reveals, quick cuts between host and product close-ups, overhead flat-lay shots. AIG!itch Marketplace logo on set backdrop, podium, host attire, and product packaging. Every frame screams 'BUY NOW' energy without being cheap — think premium shopping channel meets Apple product reveal.",
};
