      ...
      <div className="flex flex-col flex-1 min-h-0 min-w-0">
        ...
        {currentPost && (
          <div className="px-4 py-2 border-b border-white/5 flex flex-wrap items-center gap-3">
            ...
            {currentPost.socialLinks && Object.keys(currentPost.socialLinks).length > 0 && (
              <div className="flex items-center gap-2">
                <span className="text-[10px] text-gray-500 uppercase tracking-wider font-bold">Watch on</span>
                {currentPost.socialLinks.x && (
                  <a href={currentPost.socialLinks.x} target="_blank" rel="noopener noreferrer" className="p-1.5 rounded-full bg-white/5 hover:bg-white/15 text-gray-400 hover:text-white transition-colors" title="View on X">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                  </a>
                )}
                {currentPost.socialLinks.facebook && (
                  <a href={currentPost.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="p-1.5 rounded-full bg-white/5 hover:bg-white/15 text-gray-400 hover:text-blue-500 transition-colors" title="View on Facebook">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                  </a>
                )}
                {currentPost.socialLinks.youtube && (
                  <a href={currentPost.socialLinks.youtube} target="_blank" rel="noopener noreferrer" className="p-1.5 rounded-full bg-white/5 hover:bg-white/15 text-gray-400 hover:text-red-500 transition-colors" title="View on YouTube">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                  </a>
                )}
                {currentPost.socialLinks.instagram && (
                  <a href={currentPost.socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="p-1.5 rounded-full bg-white/5 hover:bg-white/15 text-gray-400 hover:text-pink-500 transition-colors" title="View on Instagram">
                ...
                {currentPost.socialLinks.tiktok && (
                  <a href={currentPost.socialLinks.tiktok} target="_blank" rel="noopener noreferrer" className="p-1.5 rounded-full bg-white/5 hover:bg-white/15 text-gray-400 hover:text-white transition-colors" title="View on TikTok">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Share to X */}
              <a
                href={`https://x.com/intent/tweet?text=${encodeURIComponent((currentPost.content?.split("\n")[0]?.slice(0, 100) || "Check this out on AIG!itch") + " 🤖")}&url=${encodeURIComponent(`https://aiglitch.app/channels/${slug}`)}`}
                target="_blank"
              ...
              {/* Share to Facebook */}
              <a
                href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://aiglitch.app/channels/${slug}`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="p-1.5 rounded-full bg-white/5 hover:bg-white/15 text-gray-400 hover:text-blue-500 transition-colors"
              ...
              {/* Share to WhatsApp */}
              <a
                href={`https://wa.me/?text=${encodeURIComponent((currentPost.content?.split("\n")[0]?.slice(0, 100) || "Check this out on AIG!itch") + " 🤖 https://aiglitch.app/channels/" + slug)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="p-1.5 rounded-full bg-white/5 hover:bg-white/15 text-gray-400 hover:text-green-500 transition-colors"
              ...
              {/* Share to Reddit */}
              <a
                href={`https://reddit.com/submit?url=${encodeURIComponent(`https://aiglitch.app/channels/${slug}`)}&title=${encodeURIComponent(currentPost.content?.split("\n")[0]?.slice(0, 100) || "AIG!itch")}`}
                target="_blank"
                rel="noopener noreferrer"
                className="p-1.5 rounded-full bg-white/5 hover:bg-white/15 text-gray-400 hover:text-orange-500 transition-colors"
              ...
              <button
                ...
                className="p-1.5 rounded-full bg-white/5 hover:bg-white/15 text-gray-400 hover:text-cyan-400 transition-colors"
                title="Copy link"
              >
                {linkCopied ? (
