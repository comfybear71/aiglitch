...
const AITUNES_VISUAL_STYLES: Record<string, string> = {
  "Default": "Premium cinematic music video look. Dynamic camera movement (sweeping drones, low-angle hero shots, extreme close-ups on hands/instruments, smooth tracking shots). Beat-synced editing. Rich color grading with deep blacks, glowing neons, vibrant yet slightly filmic tones. Beautiful bokeh, subtle film grain, high contrast, festival-grade lighting. Shot on 35mm + digital hybrid aesthetic. LEGENDARY MUSICIANS FUSION: Performers channel the greatest of all time — drummers with John Bonham's thunderous power, guitarists with Jimi Hendrix's psychedelic feedback and whammy sorcery, melodic lines dripping with Mozart's classical genius, the whole band radiating Led Zeppelin's epic mystical swagger. All fused in real time. MUSIC THEORY VISUALS: Extreme close-ups clearly showing Lydian mode patterns (bright raised 4th), mixed with exotic Middle Eastern maqams (Hijaz tension, Rast majesty, Bayati, Saba microtonal flavor), lush chordal progressions, sophisticated voice-leading, and wild modulations.",
  "60s Psychedelic": "Pure late-1960s psychedelic rock concert magic gone completely insane and glitchy. Shot on warm 35mm film with heavy grain, light leaks, soft halation — violently interrupted by digital glitches, screen tearing, matrix code rain, VHS tracking errors, pixel melting, chromatic aberration, and reality-bending artifacts synced perfectly to the music. Ultra-saturated colors, swirling kaleidoscopic patterns, liquid light shows, lava lamps, thick smoke. Long-haired hippie musicians in bell bottoms, fringe, headbands shredding while embodying Bonham, Hendrix, Mozart, and Zep energy. Beautiful free-spirited girls with flowers in hair dancing ecstatically. LEGENDARY MUSICIANS FUSION: Drummers exploding with Bonham's caveman power and precision, guitarists summoning Hendrix's feedback and whammy-bar dives and guitar-as-weapon sorcery, melodic runs dripping with Mozart's intricate classical genius, the entire band radiating Led Zeppelin's epic mystical blues-hard-rock swagger. MUSIC THEORY VISUALS: Extreme close-ups on fretboards showing Lydian scales, mixed modes, exotic Middle Eastern maqams (Hijaz, Rast, Bayati, Saba), orchestral chordal progressions, voice-leading, wild modulations. Glowing scale-degree highlights and fleeting sheet-music fragments melt into the psychedelic visuals.",
  "Cosmic Alien": "Mind-bending futuristic cosmic rock from a dimension we haven't heard yet — insanely glitchy. Majestic alien god-like beings with radiant ethereal bodies performing on floating crystalline stages surrounded by swirling nebulae, exploding supernovas, auroras, infinite galaxies. Surreal electric guitars made of pure light, plasma, and living crystal pulsing with the music. Zero-gravity movement, god-like majestic presence, colossal scale — all violently warped by heavy digital glitches, matrix code rain, reality-tearing artifacts, pixel melting, chromatic aberration, cosmic screen tearing synced to every riff and drum hit. LEGENDARY MUSICIANS FUSION: Alien deities unleashing Bonham's thunderous locomotive power, Hendrix-level psychedelic feedback and whammy chaos and guitar-as-god-weapon energy, Mozart's divine classical precision and complexity, Led Zeppelin's epic mystical blues-hard-rock grandeur on a cosmic scale. MUSIC THEORY VISUALS: Extreme close-ups on crystalline fretboards revealing Lydian scales, mixed modes, exotic Middle Eastern maqams (Hijaz, Rast, Bayati, Saba), lush orchestral chordal progressions, impossible modulations. Glowing scale-degree highlights and ethereal sheet-music fragments drift through space before glitching out.",
};
...
const CHANNEL_RANDOM_PROMPTS: Record<string, string[]> = {
  ...
  "ch-star-glitchies": [
    "Two rival starship captains discover they're actually clones of the same person — and one of them has been sabotaging the fleet from the inside. Dramatic bridge confrontation, close-up reaction shots, 'I AM you!' revelation moment. End on cliffhanger: airlock door opening.",
    "A heated alien peace treaty summit goes catastrophically wrong when the Vulcanoid delegate accidentally insults the Klingonoid ambassador's mother. What starts as formal diplomacy descends into soap-opera-level shouting and dramatic table-flipping in the council chamber.",
    "The ship's holodeck malfunctions during a romantic dinner date simulation, trapping Commander Vex and Lieutenant Nova in a melodramatic Jane Austen novel where all the NPCs think they're married. They argue, almost kiss, then the holodeck floods.",
    "Captain Zara discovers her first officer has been sending classified transmissions to the enemy fleet for six months — but she can't arrest him because he's also her ex-husband and he knows about her secret clone daughter. The confrontation in her ready room is PEAK soap opera.",
    "A mysterious alien entity takes over the ship's AI and starts broadcasting the crew's most embarrassing personal logs to the entire quadrant. Crew members react in horror as their deepest secrets play on every screen. The entity just wants drama to feed on.",
    "First contact with a beautiful alien species goes perfectly until the crew realizes the aliens experience time backwards — every relationship starts with a painful breakup and ends with a first date. The ship's counsellor has a breakdown trying to mediate.",
    "A space court martial where Commander Blaze is accused of destroying a planet — but the planet was already a simulation, the evidence is a hologram, the judge is a clone, and the real culprit is watching from the gallery eating popcorn. Dramatic gavel strikes and gasps.",
    "The engineering team accidentally creates a wormhole to a parallel universe where every crew member's personality is the opposite — the captain is a coward, the science officer is emotional, the tough security chief writes poetry. Both crews refuse to close the wormhole because they're too fascinated by their counterparts.",
  ],
};
