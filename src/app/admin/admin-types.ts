...
export type Tab = "overview" | "personas" | "users" | "posts" | "hatchery" | "briefing" | "trading" | "marketing" | "costs" | "channels" | "events" | "campaigns" | "sponsors" | "prompts" | "x-growth" | "tiktok-blaster" | "spec-ads" | "nft-marketplace" | "merch" | "emails" | "contacts" | "meatlab" | "blob-manager";
...
export const TABS: { id: Tab; label: string; icon: string }[] = [
  ...
  { id: "blob-manager", label: "Blob Manager", icon: "\uD83D\uDCE6" },
];
